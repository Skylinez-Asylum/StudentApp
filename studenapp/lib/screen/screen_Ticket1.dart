...
class Ticket1Screen extends StatelessWidget {
  const Ticket1Screen({super.key});
    ...
    return SafeArea(
      ...
      crossAxisAlignment:CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Container(height:600 ,width: 300,decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: Colors.green),
          child: Padding(
  ...
  Widget build(BuildContext context) {
    ...
    child: Stack(children: [
      ...
      Positioned(
        ...
        Positioned(top: 485,left: 30,
        child: ElevatedButton(onPressed: (){}, child: Text("Payment Completed",style: TextStyle(fontSize: 16,color: Colors.green),),
                          style:ElevatedButton.styleFrom(side: BorderSide(color: Colors.green,width: 2),
                          primary: Colors.transparent,fixedSize: Size(180, 50)),)),

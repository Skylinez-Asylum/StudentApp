...
class OtpPhoneNo extends StatelessWidget {
  const OtpPhoneNo({super.key});
        ...
        child: Container(height: 200,width: MediaQuery.of(context).size.width-40,
                        ...
                        child: Column(children: [
                          ...
                          SizedBox(height: 50,width: 300,
                            child: TextField(style: TextStyle(color: Colors.white),decoration: InputDecoration(filled: true,hintText: "Phone No",
